...
best_model_state_dict = torch.load(join(args.output_folder, "/content/drive/MyDrive/IA_project/project_vg/runs/default/2022-01-13_15-49-20/best_model.pth"))["model_state_dict"]
